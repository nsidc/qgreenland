...
esa_cci_velocity_magnitude = ConfigLayer(
    id='esa_cci_velocity_magnitude',
    title='Land ice surface velocity 2019-2020 (250m)',
    description=(
        """Magnitude of horizontal ice velocity in meters per day. Data is not
        masked to ice sheet boundary."""
    ),
    tags=[],
    ...
    steps=[
        ...
        *warp_and_cut(
            ...
            output_file='{output_dir}/magnitude.tif',
            cut_file=project.boundaries['data'].filepath,
        ),
        *build_overviews(
            input_file='{input_dir}/magnitude.tif',
            output_file='{output_dir}/magnitude.tif',
        ),
    ],
)
