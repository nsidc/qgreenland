...
greenland_onshore_pattern = ConfigDataset(
    id='greenland_onshore_pattern',
    assets=[
    ...
    metadata={
        'title': " ",
        'abstract': (
            """Geological unit polygon feature class for the onshore landmass and islands of Greenland."""
        ),
        'citation': {
            'text': (
