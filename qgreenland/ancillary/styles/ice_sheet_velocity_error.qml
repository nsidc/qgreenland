...
<qgis hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="1e+08" version="3.28.6-Firenze">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMax="10111.6865234" alphaBand="-1" band="1" nodataColor="" classificationMin="0.0001817" type="singlebandpseudocolor" opacity="1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader maximumValue="10111.6865234" colorRampType="INTERPOLATED" minimumValue="0.0001817" classificationMode="3" clip="0" labelPrecision="2">
          ...
          <item alpha="255" color="#440154" label="0.02 m/y" value="0.021078992635012"/>
          <item alpha="255" color="#414387" label="3.81 m/y" value="3.81084350002154"/>
          <item alpha="255" color="#2a788e" label="7.04 m/y" value="7.043817961299146"/>
          <item alpha="255" color="#23a884" label="12.16 m/y" value="12.155509803963628"/>
          <item alpha="255" color="#7ad151" label="25.51 m/y" value="25.511286522886007"/>
          <item alpha="255" color="#fde725" label="7898.71 m/y" value="7898.70574038917"/>
          <rampLegendSettings prefix="" useContinuousLegend="1" direction="0" minimumLabel="" suffix=" m/y" orientation="1" maximumLabel="">
