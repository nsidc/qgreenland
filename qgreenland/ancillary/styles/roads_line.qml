...
<qgis version="3.10.4-A Coruña" simplifyDrawingHints="1" styleCategories="Symbology|Labeling|Rendering" hasScaleBasedVisibilityFlag="1" maxScale="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" labelsEnabled="1" simplifyAlgorithm="0" minScale="26000">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style isExpression="0" fontSizeUnit="Point" fontWeight="50" fontKerning="1" namedStyle="" fontItalic="0" fontUnderline="0" multilineHeight="1" textOpacity="1" fontFamily="Open Sans" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" fontSize="10" fontLetterSpacing="0" textColor="0,0,0,255" fontWordSpacing="0" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" blendMode="0" fieldName="name" fontCapitals="0">
      ...
      <text-format wrapChar="" rightDirectionSymbol=">" addDirectionSymbol="0" plussign="0" reverseDirectionSymbol="0" multilineAlign="0" leftDirectionSymbol="&lt;" formatNumbers="0" autoWrapLength="0" decimals="3" placeDirectionSymbol="0" useMaxLineLengthForAutoWrap="1"/>
      <placement xOffset="0" preserveRotation="1" centroidWhole="0" maxCurvedCharAngleOut="-25" fitInPolygonOnly="0" offsetUnits="MM" placement="2" overrunDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="LineGeometry" quadOffset="4" centroidInside="0" priority="5" rotationAngle="0" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" repeatDistance="0" geometryGeneratorEnabled="0" distUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" repeatDistanceUnits="MM" yOffset="0" offsetType="0" geometryGeneratorType="PointGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" dist="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGenerator=""/>
      <rendering fontMaxPixelSize="10000" obstacleFactor="1" obstacle="1" drawLabels="1" scaleMax="2000" fontMinPixelSize="3" displayAll="0" zIndex="0" obstacleType="0" labelPerPart="0" minFeatureSize="0" scaleMin="0" upsidedownLabels="0" fontLimitPixelSize="0" scaleVisibility="1" mergeLines="0" limitNumLabels="0" maxNumLabels="2000"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" value="" name="name"/>
          <Option name="properties"/>
