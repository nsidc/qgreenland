...
<qgis hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="1e+08" version="3.28.6-Firenze">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMax="8" alphaBand="-1" band="1" nodataColor="" classificationMin="-8" type="singlebandpseudocolor" opacity="1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader maximumValue="8" colorRampType="INTERPOLATED" minimumValue="-8" classificationMode="2" clip="0" labelPrecision="0">
          ...
          <item alpha="255" color="#181c43" label="-8 m/y" value="-8"/>
          <item alpha="255" color="#3888ba" label="-4 m/y" value="-4"/>
          <item alpha="255" color="#f1eceb" label="0 m/y" value="0"/>
          <item alpha="255" color="#bf573a" label="4 m/y" value="4"/>
          <item alpha="255" color="#3c0912" label="8 m/y" value="8"/>
