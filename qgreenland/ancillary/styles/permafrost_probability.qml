...
<qgis hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="1e+08" version="3.28.6-Firenze">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMax="1" alphaBand="-1" band="1" nodataColor="" classificationMin="0" type="singlebandpseudocolor" opacity="1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader maximumValue="1" colorRampType="INTERPOLATED" minimumValue="0" classificationMode="2" clip="0" labelPrecision="-10">
          ...
          <item alpha="255" color="#3b528b" label="25%" value="0.25"/>
          <item alpha="255" color="#21908d" label="50%" value="0.5"/>
          <item alpha="255" color="#5dc963" label="75%" value="0.75"/>
          <item alpha="255" color="#fde725" label="100%" value="1"/>
          <rampLegendSettings prefix="" useContinuousLegend="1" direction="0" minimumLabel="0" suffix="%" orientation="1" maximumLabel="100">
