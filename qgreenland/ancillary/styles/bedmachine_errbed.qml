...
<qgis version="3.28.6-Firenze" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="1e+08">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" nodataColor="" classificationMax="3808" type="singlebandpseudocolor" band="1" opacity="1" classificationMin="0">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader clip="0" colorRampType="INTERPOLATED" maximumValue="3808" minimumValue="0" labelPrecision="0" classificationMode="1">
          <colorramp name="[source]" type="cpt-city">
            <Option type="Map">
              ...
              <Option name="schemeName" type="QString" value="ds9/red"/>
              <Option name="variantName" type="QString" value=""/>
            </Option>
          </colorramp>
          <item value="0" color="#000000" alpha="255" label="0m"/>
          <item value="3808" color="#ff0000" alpha="255" label="3808m"/>
