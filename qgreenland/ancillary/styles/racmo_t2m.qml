...
<qgis hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="1e+08" version="3.28.6-Firenze">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMax="280" alphaBand="-1" band="1" nodataColor="" classificationMin="240" type="singlebandpseudocolor" opacity="1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader maximumValue="280" colorRampType="INTERPOLATED" minimumValue="240" classificationMode="2" clip="0" labelPrecision="0">
          ...
          <item alpha="255" color="#440154" label="240°K" value="240"/>
          <item alpha="255" color="#482576" label="244°K" value="244"/>
          <item alpha="255" color="#414387" label="248°K" value="248"/>
          <item alpha="255" color="#345f8d" label="252°K" value="252"/>
          <item alpha="255" color="#2a788e" label="256°K" value="256"/>
          <item alpha="255" color="#21908d" label="260°K" value="260"/>
          <item alpha="255" color="#23a884" label="264°K" value="264"/>
          <item alpha="255" color="#43bf70" label="268°K" value="268"/>
          <item alpha="255" color="#7ad151" label="272°K" value="272"/>
          <item alpha="255" color="#bcdf27" label="276°K" value="276"/>
          <item alpha="255" color="#fde725" label="280°K" value="280"/>
          <rampLegendSettings prefix="" useContinuousLegend="1" direction="0" minimumLabel="" suffix="°K" orientation="1" maximumLabel="">
