...
<qgis version="3.10.4-A Coruña" minScale="1e+08" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0">
  <flags>
  ...
  <pipe>
    <rasterrenderer type="singlebandpseudocolor" band="1" classificationMin="240" classificationMax="280" opacity="1" alphaBand="-1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" classificationMode="2" clip="0">
          ...
          <item label="240 °K" value="240" color="#440154" alpha="255"/>
          <item label="244 °K" value="244" color="#482475" alpha="255"/>
          <item label="248 °K" value="248" color="#404387" alpha="255"/>
          <item label="252 °K" value="252" color="#345f8d" alpha="255"/>
          <item label="256 °K" value="256" color="#29788e" alpha="255"/>
          <item label="260 °K" value="260" color="#20908d" alpha="255"/>
          <item label="264 °K" value="264" color="#22a884" alpha="255"/>
          <item label="268 °K" value="268" color="#43bf70" alpha="255"/>
          <item label="272 °K" value="272" color="#7ad251" alpha="255"/>
          <item label="276 °K" value="276" color="#bcdf27" alpha="255"/>
          <item label="280 °K" value="280" color="#fde725" alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
    <brightnesscontrast brightness="0" contrast="0"/>
    <huesaturation colorizeGreen="128" saturation="0" colorizeRed="255" grayscaleMode="0" colorizeOn="0" colorizeStrength="100" colorizeBlue="128"/>
