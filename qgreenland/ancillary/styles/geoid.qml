...
<qgis version="3.28.7-Firenze" minScale="1e+08" styleCategories="AllStyleCategories" maxScale="0" hasScaleBasedVisibilityFlag="0">
  <flags>
  ...
  <elevation symbology="Line" zoffset="0" band="1" zscale="1" enabled="0">
    ...
    <profileLineSymbol>
      <symbol frame_rate="10" name="" force_rhr="0" is_animated="0" clip_to_extent="1" type="line" alpha="1">
    ...
    <profileFillSymbol>
      <symbol frame_rate="10" name="" force_rhr="0" is_animated="0" clip_to_extent="1" type="fill" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
  ...
  <pipe>
    ...
    <rasterrenderer nodataColor="" alphaBand="-1" band="1" classificationMin="-6.7646300744401" classificationMax="67.514496420723" type="singlebandpseudocolor" opacity="1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" classificationMode="2" clip="0" maximumValue="67.514496420723006" labelPrecision="1" minimumValue="-6.7646300744400998">
          ...
          <item color="#440154" value="-6.7646300744401" alpha="255" label="-6.8 m"/>
          <item color="#482576" value="0.663282575076211" alpha="255" label="0.7 m"/>
          <item color="#414387" value="8.091195224592521" alpha="255" label="8.1 m"/>
          <item color="#345f8d" value="15.519107874108833" alpha="255" label="15.5 m"/>
          <item color="#2a788e" value="22.947020523625145" alpha="255" label="22.9 m"/>
          <item color="#21908d" value="30.374933173141457" alpha="255" label="30.4 m"/>
          <item color="#23a884" value="37.802845822657765" alpha="255" label="37.8 m"/>
          <item color="#43bf70" value="45.23075847217408" alpha="255" label="45.2 m"/>
          <item color="#7ad151" value="52.65867112169039" alpha="255" label="52.7 m"/>
          <item color="#bcdf27" value="60.0865837712067" alpha="255" label="60.1 m"/>
          <item color="#fde725" value="67.514496420723" alpha="255" label="67.5 m"/>
          <rampLegendSettings prefix="" direction="0" maximumLabel="" minimumLabel="" useContinuousLegend="1" orientation="1" suffix=" m">
    ...
    <huesaturation colorizeRed="255" saturation="0" colorizeStrength="100" grayscaleMode="0" colorizeGreen="128" colorizeBlue="128" invertColors="0" colorizeOn="0"/>
