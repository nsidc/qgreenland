...
<qgis maxScale="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.10.4-A Coruña">
  <flags>
  ...
  <pipe>
    <rasterrenderer opacity="1" alphaBand="-1" band="1" classificationMax="67.514" classificationMin="-6.85866" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" classificationMode="2" clip="0">
          ...
          <item label="-6.85866 m" value="-6.85866" alpha="255" color="#440154"/>
          <item label="0.578605999999999 m" value="0.578605999999999" alpha="255" color="#482475"/>
          <item label="8.015872 m" value="8.015872" alpha="255" color="#404387"/>
          <item label="15.453138 m" value="15.453138" alpha="255" color="#345f8d"/>
          <item label="22.890404 m" value="22.890404" alpha="255" color="#29788e"/>
          <item label="30.32767 m" value="30.32767" alpha="255" color="#20908d"/>
          <item label="37.764936 m" value="37.764936" alpha="255" color="#22a884"/>
          <item label="45.202202 m" value="45.202202" alpha="255" color="#43bf70"/>
          <item label="52.639468 m" value="52.639468" alpha="255" color="#7ad251"/>
          <item label="60.076734 m" value="60.076734" alpha="255" color="#bcdf27"/>
          <item label="67.514 m" value="67.514" alpha="255" color="#fde725"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
    <brightnesscontrast brightness="0" contrast="0"/>
    <huesaturation colorizeOn="0" colorizeRed="255" colorizeStrength="100" colorizeBlue="128" grayscaleMode="0" colorizeGreen="128" saturation="0"/>
