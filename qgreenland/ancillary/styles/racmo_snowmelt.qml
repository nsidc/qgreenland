...
<qgis hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="1e+08" version="3.28.6-Firenze">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMax="11621.3154297" alphaBand="-1" band="1" nodataColor="" classificationMin="0.3517693" type="singlebandpseudocolor" opacity="1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader maximumValue="11621.3154297" colorRampType="INTERPOLATED" minimumValue="0.35176930000000001" classificationMode="2" clip="0" labelPrecision="2">
          ...
          <item alpha="255" color="#440154" label="0.35mm w.e." value="0.3517693"/>
          <item alpha="255" color="#472c7c" label="1452.97mm w.e." value="1452.97222685"/>
          <item alpha="255" color="#3b528b" label="2905.59mm w.e." value="2905.5926844"/>
          <item alpha="255" color="#2c728e" label="4358.21mm w.e." value="4358.213141950001"/>
          <item alpha="255" color="#21908d" label="5810.83mm w.e." value="5810.833599500001"/>
          <item alpha="255" color="#28ae80" label="7263.45mm w.e." value="7263.45405705"/>
          <item alpha="255" color="#5dc963" label="8716.07mm w.e." value="8716.0745146"/>
          <item alpha="255" color="#abdc32" label="10168.69mm w.e." value="10168.69497215"/>
          <item alpha="255" color="#fde725" label="11621.32mm w.e." value="11621.3154297"/>
