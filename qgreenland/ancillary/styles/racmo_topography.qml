...
<qgis version="3.10.4-A Coruña" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="1e+08" maxScale="0">
  <flags>
  ...
  <pipe>
    <rasterrenderer classificationMin="0" classificationMax="3480" opacity="1" band="1" alphaBand="-1" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader clip="0" classificationMode="2" colorRampType="INTERPOLATED">
          ...
          <item color="#462c7b" label="435" value="435" alpha="255"/>
          <item color="#3a528b" label="870" value="870" alpha="255"/>
          <item color="#2b728e" label="1305" value="1305" alpha="255"/>
          <item color="#20908d" label="1740" value="1740" alpha="255"/>
          <item color="#27ae80" label="2175" value="2175" alpha="255"/>
          <item color="#5dc962" label="2610" value="2610" alpha="255"/>
          <item color="#abdc32" label="3045" value="3045" alpha="255"/>
          <item color="#fde725" label="3480" value="3480" alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
    <brightnesscontrast brightness="0" contrast="0"/>
    <huesaturation colorizeGreen="128" colorizeBlue="128" saturation="0" colorizeStrength="100" grayscaleMode="0" colorizeRed="255" colorizeOn="0"/>
