...
<qgis hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="1e+08" version="3.28.6-Firenze">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMax="3480" alphaBand="-1" band="1" nodataColor="" classificationMin="0" type="singlebandpseudocolor" opacity="1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader maximumValue="3480" colorRampType="INTERPOLATED" minimumValue="0" classificationMode="2" clip="0" labelPrecision="0">
          ...
          <item alpha="255" color="#440154" label="0m" value="0"/>
          <item alpha="255" color="#472c7c" label="435m" value="435"/>
          <item alpha="255" color="#3b528b" label="870m" value="870"/>
          <item alpha="255" color="#2c728e" label="1305m" value="1305"/>
          <item alpha="255" color="#21908d" label="1740m" value="1740"/>
          <item alpha="255" color="#28ae80" label="2175m" value="2175"/>
          <item alpha="255" color="#5dc963" label="2610m" value="2610"/>
          <item alpha="255" color="#abdc32" label="3045m" value="3045"/>
          <item alpha="255" color="#fde725" label="3480m" value="3480"/>
          <rampLegendSettings prefix="" useContinuousLegend="1" direction="0" minimumLabel="" suffix="m" orientation="1" maximumLabel="">
