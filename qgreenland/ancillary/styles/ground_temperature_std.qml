...
<qgis hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" minScale="1e+08" version="3.28.6-Firenze">
  ...
  <pipe>
    ...
    <rasterrenderer classificationMax="3.54099" alphaBand="-1" band="1" nodataColor="" classificationMin="0" type="singlebandpseudocolor" opacity="1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
        ...
        <stdDevFactor>0</stdDevFactor>
      </minMaxOrigin>
      <rastershader>
        <colorrampshader maximumValue="3.5409899999999999" colorRampType="INTERPOLATED" minimumValue="0" classificationMode="2" clip="0" labelPrecision="2">
          ...
          <item alpha="255" color="#440154" label="0.00°C" value="0"/>
          <item alpha="255" color="#3b528b" label="0.89°C" value="0.8852475"/>
          <item alpha="255" color="#21908d" label="1.77°C" value="1.770495"/>
          <item alpha="255" color="#5dc963" label="2.66°C" value="2.6557425"/>
          <item alpha="255" color="#fde725" label="3.54°C" value="3.54099"/>
