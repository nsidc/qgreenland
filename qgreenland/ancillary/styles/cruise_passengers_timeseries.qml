...
<qgis styleCategories="Symbology|Labeling|Rendering|Temporal" simplifyDrawingTol="1" simplifyDrawingHints="0" autoRefreshMode="Disabled" labelsEnabled="1" simplifyAlgorithm="0" minScale="100000000" hasScaleBasedVisibilityFlag="0" version="3.44.7-Solothurn" simplifyMaxScale="1" symbologyReferenceScale="-1" simplifyLocal="1" autoRefreshTime="0" maxScale="0">
  <temporal endField="end_date" startField="start_date" mode="2" accumulate="0" limitMode="1" enabled="1" endExpression="" fixedDuration="0" startExpression="" durationField="passengers" durationUnit="min">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <renderer-v2 graduatedMethod="GraduatedColor" attr="passengers" enableorderby="0" symbollevels="0" referencescale="-1" type="graduatedSymbol" forceraster="0">
    <ranges>
      <range upper="1283.000000000000000" uuid="{8ecfc658-0956-40e2-b0bf-30b2740c4571}" lower="3.000000000000000" render="true" symbol="0" label="3 - 1283"/>
      <range upper="3582.000000000000000" uuid="{6f7ad15f-86a3-466e-85f0-a4558db60885}" lower="1283.000000000000000" render="true" symbol="1" label="1283 - 3582"/>
      <range upper="7245.000000000000000" uuid="{9aa1a165-2d0e-4f54-8309-9dffe0f0e880}" lower="3582.000000000000000" render="true" symbol="2" label="3582 - 7245"/>
      <range upper="13649.000000000000000" uuid="{2ed3dc28-6fb6-4ecc-92d9-fa2a6883cb1f}" lower="7245.000000000000000" render="true" symbol="3" label="7245 - 13649"/>
      <range upper="24146.000000000000000" uuid="{7e3d0ab9-7ecb-409b-96ef-180abc0de7e4}" lower="13649.000000000000000" render="true" symbol="4" label="13649 - 24146"/>
      <range upper="36744.000000000000000" uuid="{c72b9edb-c30f-4345-8442-28db997645b0}" lower="24146.000000000000000" render="true" symbol="5" label="24146 - 36744"/>
    </ranges>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="size" type="Map">
                  ...
                  <Option value="passengers" name="field" type="QString"/>
                  <Option name="transformer" type="Map">
                    <Option name="d" type="Map">
                      ...
                      <Option value="15428" name="maxValue" type="double"/>
