...
<qgis styleCategories="Symbology|Labeling|Rendering|Temporal" simplifyDrawingTol="1" simplifyDrawingHints="0" autoRefreshMode="Disabled" labelsEnabled="1" simplifyAlgorithm="0" minScale="100000000" hasScaleBasedVisibilityFlag="0" version="3.44.7-Solothurn" simplifyMaxScale="1" symbologyReferenceScale="-1" simplifyLocal="1" autoRefreshTime="0" maxScale="0">
  <temporal endField="end_date" startField="start_date" mode="2" accumulate="0" limitMode="1" enabled="1" endExpression="" fixedDuration="0" startExpression="" durationField="number_of_vessels" durationUnit="min">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <renderer-v2 graduatedMethod="GraduatedColor" attr="number_of_vessels" enableorderby="0" symbollevels="0" referencescale="-1" type="graduatedSymbol" forceraster="0">
    <ranges>
      <range upper="33.000000000000000" uuid="{92414395-9083-497d-9e8d-b40244d4ab56}" lower="0.000000000000000" render="true" symbol="0" label="0 - 33"/>
      <range upper="88.000000000000000" uuid="{9ae05657-4b66-4ead-b0d3-bd1f575ebfdd}" lower="33.000000000000000" render="true" symbol="1" label="33 - 88"/>
      <range upper="151.000000000000000" uuid="{5cdbb0a6-3de3-4180-922d-9ba98769eabd}" lower="88.000000000000000" render="true" symbol="2" label="88 - 151"/>
      <range upper="250.000000000000000" uuid="{b228b891-0c40-4cf5-9e2c-fda17eec2a87}" lower="151.000000000000000" render="true" symbol="3" label="151 - 250"/>
      <range upper="309.000000000000000" uuid="{ca1c7985-790e-4978-8d4c-4d6c4cce90a7}" lower="250.000000000000000" render="true" symbol="4" label="250 - 309"/>
      <range upper="391.000000000000000" uuid="{d408db8f-c197-4b9a-b809-fdd467c6fb7e}" lower="309.000000000000000" render="true" symbol="5" label="309 - 391"/>
    </ranges>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="size" type="Map">
                  ...
                  <Option value="number_of_vessels" name="field" type="QString"/>
                  <Option name="transformer" type="Map">
                    <Option name="d" type="Map">
                      ...
                      <Option value="391" name="maxValue" type="double"/>
