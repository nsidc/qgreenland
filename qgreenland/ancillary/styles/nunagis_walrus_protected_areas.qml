...
<qgis version="3.10.4-A Coruña" styleCategories="Symbology">
  <renderer-v2 forceraster="0" attr="type" type="categorizedSymbol" symbollevels="0" enableorderby="0">
    <categories>
      <category symbol="0" label="Walrus haulout site" value="Walrus haulout site" render="true"/>
      <category symbol="1" label="Walrus wintering or spring area" value="Walrus wintering or spring area" render="true"/>
    </categories>
    <symbols>
      <symbol alpha="1" force_rhr="0" name="0" type="fill" clip_to_extent="1">
        <layer enabled="1" class="PointPatternFill" locked="0" pass="0">
          ...
          <symbol alpha="1" force_rhr="0" name="@0@0" type="marker" clip_to_extent="1">
            <layer enabled="1" class="SimpleMarker" locked="0" pass="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="132,117,217,255"/>
        ...
        <layer enabled="1" class="SimpleLine" locked="0" pass="0">
          ...
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="132,117,217,255"/>
      ...
      <symbol alpha="1" force_rhr="0" name="1" type="fill" clip_to_extent="1">
        <layer enabled="1" class="PointPatternFill" locked="0" pass="0">
          ...
          <symbol alpha="1" force_rhr="0" name="@1@0" type="marker" clip_to_extent="1">
            <layer enabled="1" class="SimpleMarker" locked="0" pass="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="87,63,223,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="name" v="circle"/>
              <prop k="offset" v="0,0"/>
        ...
        <layer enabled="1" class="SimpleLine" locked="0" pass="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="87,63,223,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.36"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
