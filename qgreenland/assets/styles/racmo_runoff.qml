...
<qgis minScale="1e+08" version="3.10.4-A Coruña" hasScaleBasedVisibilityFlag="0" maxScale="0" styleCategories="AllStyleCategories">
  ...
  <pipe>
    <rasterrenderer band="1" classificationMin="0" classificationMax="9111.65" type="singlebandpseudocolor" opacity="1" alphaBand="-1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" clip="0" classificationMode="2">
          ...
          <item label="1138.95617675781 mm w.e." value="1138.95617675781" color="#462c7b" alpha="255"/>
          <item label="2277.91235351563 mm w.e." value="2277.91235351563" color="#3a528b" alpha="255"/>
          <item label="3416.86853027344 mm w.e." value="3416.86853027344" color="#2b728e" alpha="255"/>
          <item label="4555.82470703125 mm w.e." value="4555.82470703125" color="#20908d" alpha="255"/>
          <item label="5694.78088378906 mm w.e." value="5694.78088378906" color="#27ae80" alpha="255"/>
          <item label="6833.73706054688 mm w.e." value="6833.73706054688" color="#5dc962" alpha="255"/>
          <item label="7972.69323730469 mm w.e." value="7972.69323730469" color="#abdc32" alpha="255"/>
          <item label="9111.6494140625 mm w.e." value="9111.6494140625" color="#fde725" alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
