...
<qgis minScale="1e+08" version="3.10.4-A Coruña" hasScaleBasedVisibilityFlag="0" maxScale="0" styleCategories="AllStyleCategories">
  ...
  <pipe>
    <rasterrenderer classificationMin="0" alphaBand="-1" band="1" classificationMax="3.54099" opacity="1" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader clip="0" classificationMode="2" colorRampType="INTERPOLATED">
          ...
          <item color="#440154" label="0 °C" value="0" alpha="255"/>
          <item color="#3a528b" label="0.8852475 °C" value="0.8852475" alpha="255"/>
          <item color="#20908d" label="1.770495 °C" value="1.770495" alpha="255"/>
          <item color="#5dc962" label="2.6557425 °C" value="2.6557425" alpha="255"/>
          <item color="#fde725" label="3.54099 °C" value="3.54099" alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
    <brightnesscontrast brightness="0" contrast="0"/>
    <huesaturation saturation="0" colorizeRed="255" colorizeGreen="128" colorizeBlue="128" colorizeStrength="100" colorizeOn="0" grayscaleMode="0"/>
