    ...
    <rasterrenderer classificationMin="0" alphaBand="-1" band="1" classificationMax="3.54099" opacity="1" type="singlebandpseudocolor">
      ...
      <rastershader>
        <colorrampshader clip="0" classificationMode="2" colorRampType="INTERPOLATED">
          ...
          <item color="#3a528b" label="0.8852475" value="0.8852475" alpha="255"/>
          <item color="#20908d" label="1.770495" value="1.770495" alpha="255"/>
          <item color="#5dc962" label="2.6557425" value="2.6557425" alpha="255"/>
          <item color="#fde725" label="3.54099" value="3.54099" alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
