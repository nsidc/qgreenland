...
<qgis minScale="1e+08" version="3.10.4-A Coruña" hasScaleBasedVisibilityFlag="0" maxScale="0" styleCategories="AllStyleCategories">
  ...
  <pipe>
    <rasterrenderer band="1" classificationMin="0.351769" classificationMax="11621.3" type="singlebandpseudocolor" opacity="1" alphaBand="-1">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" clip="0" classificationMode="2">
          ...
          <item label="0.351769 mm w.e." value="0.351769" color="#440154" alpha="255"/>
          <item label="1452.970297875 mm w.e." value="1452.970297875" color="#462c7b" alpha="255"/>
          <item label="2905.58882675 mm w.e." value="2905.58882675" color="#3a528b" alpha="255"/>
          <item label="4358.207355625 mm w.e." value="4358.207355625" color="#2b728e" alpha="255"/>
          <item label="5810.8258845 mm w.e." value="5810.8258845" color="#20908d" alpha="255"/>
          <item label="7263.444413375 mm w.e." value="7263.444413375" color="#27ae80" alpha="255"/>
          <item label="8716.06294225 mm w.e." value="8716.06294225" color="#5dc962" alpha="255"/>
          <item label="10168.681471125 mm w.e." value="10168.681471125" color="#abdc32" alpha="255"/>
          <item label="11621.3 mm w.e." value="11621.3" color="#fde725" alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
