...
<qgis minScale="1e+08" version="3.10.4-A Coruña" hasScaleBasedVisibilityFlag="0" maxScale="0" styleCategories="AllStyleCategories">
  ...
  <pipe>
    <rasterrenderer classificationMin="0" alphaBand="-1" band="1" classificationMax="1" opacity="1" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
      ...
      <rastershader>
        <colorrampshader clip="0" classificationMode="2" colorRampType="INTERPOLATED">
          ...
          <item color="#3a528b" label="25%" value="0.25" alpha="255"/>
          <item color="#20908d" label="50%" value="0.5" alpha="255"/>
          <item color="#5dc962" label="75%" value="0.75" alpha="255"/>
          <item color="#fde725" label="100%" value="1" alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
